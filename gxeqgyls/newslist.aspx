...
{
	/*方配软件技术有限公司(WMS框架)，官方网站：http://www.fangpage.com，生成时间：2015-09-28 14:02:06*/
	...
	ViewBuilder.Append("            <div class=\"right_top\"> <a target=\"_blank\" href=\"index.aspx\">首页</a>&nbsp;>&nbsp;<a href=\"newslist.aspx?sortid=" + sortid.ToString() + "\">" + sortinfo.name.ToString().Trim() + "</a> > 列表</div>\r\n");
	...
	ViewBuilder.Append("              <div class=\"pagelist\"> <a class=\"a1\">共有" + pager.total.ToString().Trim() + "条</a> <a href=\"?sortid=" + sortid.ToString() + "&pageindex=" + pager.prepage.ToString().Trim() + "\" class=\"a1\">上一页</a> <a href=\"?sortid=" + sortid.ToString() + "&pageindex=" + pager.nextpage.ToString().Trim() + "\" class=\"a1\">下一页</a>\r\n");
	ViewBuilder.Append("                <input class=\"t\" id=\"page\">\r\n");
	ViewBuilder.Append("                <input class=\"b\" type=\"button\" onclick=\"clicke(" + sortid.ToString() + ")\">\r\n");
	ViewBuilder.Append("              </div>\r\n");
	ViewBuilder.Append("            </div>\r\n");
	ViewBuilder.Append("          </div>\r\n");
	ViewBuilder.Append("        </div>\r\n");
