<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_GuestBook.Controller.guestbookmanage" %>
...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("<title>留言管理</title>\r\n");
	...
	ViewBuilder.Append("              <li style=\"background: url(" + adminpath.ToString() + "images/refresh.gif) 2px 6px no-repeat\"><a href=\"guestbookmanage.aspx?sortid=" + sortid.ToString() + "\">刷新</a> </li>\r\n");
	...
	ViewBuilder.Append("              <td>留言内容</td>\r\n");
	ViewBuilder.Append("              <td width=\"120\">提交时间</td>\r\n");
	ViewBuilder.Append("              <td width=\"40\">状态</td>\r\n");
	ViewBuilder.Append("              <td width=\"100\">操作</td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");

	loop__id=0;
	foreach(GuestBookInfo item in guestbooklist)
	{
	loop__id++;
	...
	ViewBuilder.Append("              </td>\r\n");
	ViewBuilder.Append("              <td align=\"center\">" + item.content.ToString().Trim() + "</td>\r\n");
	ViewBuilder.Append("              <td align=\"center\">" + FangPage.MVC.FPUtils.GetDate(item.postdatetime,"yyyy-MM-dd HH:mm:dd") + "</td>\r\n");
	...
	ViewBuilder.Append("              </td>\r\n");
	ViewBuilder.Append("              <td>\r\n");
	ViewBuilder.Append("                  <a style=\"color: #1317fc\" href=\"guestbookadd.aspx?id=" + item.id.ToString().Trim() + "\">审核</a>\r\n");
	ViewBuilder.Append("              </td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	...
	ViewBuilder.Append("    </tr>\r\n");
	ViewBuilder.Append("    <tr>\r\n");
	ViewBuilder.Append("       <td align=\"left\">共有" + pager.total.ToString().Trim() + "条留言，页次：" + pager.pageindex.ToString().Trim() + "/" + pager.pagecount.ToString().Trim() + "，" + pager.pagesize.ToString().Trim() + "条每页</td>\r\n");
