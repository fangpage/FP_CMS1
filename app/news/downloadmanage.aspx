...
protected override void View()
{
	...
	ViewBuilder.Append("              <li style=\"background: url(" + echo(adminpath) + "statics/images/add.gif) 2px 6px no-repeat\"><a href=\"downloadadd.aspx?sortid=" + echo(sortid) + "&typeid=" + echo(typeid) + "\">添加</a></li>\r\n");
	ViewBuilder.Append("              <li style=\"background: url(" + echo(adminpath) + "statics/images/refresh.gif) 2px 6px no-repeat\"><a href=\"downloadmanage.aspx?sortid=" + echo(sortid) + "&typeid=" + echo(typeid) + "\">刷新</a> </li>\r\n");
	...
	ViewBuilder.Append("              <td align=\"center\">" + echo(news.downloads) + "</td>\r\n");
	...
	ViewBuilder.Append("              </td>\r\n");
	ViewBuilder.Append("              <td><a style=\"color: #1317fc\" href=\"downloadadd.aspx?id=" + echo(news.id) + "\">编辑</a></td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	}//end loop
	ViewBuilder.Append("          </tbody>\r\n");
	...
	ViewBuilder.Append("    </tr>\r\n");
	ViewBuilder.Append("    <tr>\r\n");
	ViewBuilder.Append("       <td align=\"left\">共有" + echo(pager.total) + "个下载，页次：" + echo(pager.pageindex) + "/" + echo(pager.pagecount) + "，" + echo(pager.pagesize) + "条每页</td>\r\n");
