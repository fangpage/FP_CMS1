...
{
	/*方配软件技术有限公司(WMS框架)，官方网站：http://www.fangpage.com，生成时间：2015-11-12 23:35:16*/
	...
	ViewBuilder.Append("<title>下载管理</title>\r\n");
	...
	ViewBuilder.Append("              <li style=\"background: url(" + adminpath.ToString() + "images/add.gif) 2px 6px no-repeat\"><a href=\"downloadadd.aspx?sortid=" + sortid.ToString() + "&typeid=" + typeid.ToString() + "\">添加</a></li>\r\n");
	ViewBuilder.Append("              <li style=\"background: url(" + adminpath.ToString() + "images/refresh.gif) 2px 6px no-repeat\"><a href=\"downloadmanage.aspx?sortid=" + sortid.ToString() + "&typeid=" + typeid.ToString() + "\">刷新</a> </li>\r\n");
	...
	ViewBuilder.Append("              <td width=\"40\">下载数</td>\r\n");
	...
	ViewBuilder.Append("              <td align=\"center\">" + news.downloads.ToString().Trim() + "</td>\r\n");
	...
	ViewBuilder.Append("              </td>\r\n");
	ViewBuilder.Append("              <td><a style=\"color: #1317fc\" href=\"downloadadd.aspx?id=" + news.id.ToString().Trim() + "\">编辑</a></td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	...
	ViewBuilder.Append("    </tr>\r\n");
	ViewBuilder.Append("    <tr>\r\n");
	ViewBuilder.Append("       <td align=\"left\">共有" + pager.total.ToString().Trim() + "个下载，页次：" + pager.pageindex.ToString().Trim() + "/" + pager.pagecount.ToString().Trim() + "，" + pager.pagesize.ToString().Trim() + "条每页</td>\r\n");
