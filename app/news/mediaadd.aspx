...
protected override void View()
{
	...
	ViewBuilder.Append("        PageNav(\"" + echo(GetSortNav(sortinfo,m_link)) + "|添加编辑图片," + echo(rawurl) + "\");\r\n");
	...
	ViewBuilder.Append("            window.location.href = \"mediamanage.aspx?sortid=" + echo(sortid) + "\";\r\n");
	ViewBuilder.Append("        })\r\n");
	ViewBuilder.Append("    });\r\n");
	ViewBuilder.Append("</");
	ViewBuilder.Append("script>\r\n");
	...
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("          <td style=\"width:60px\">视频名称： </td>\r\n");
	...
	{
	loop__id++;
	ViewBuilder.Append("            <input id=\"typelist1\" name=\"typelist\" value=\"" + echo(types2.id) + "\" "+(FPArray.Contain(newsinfo.typelist,types2.id)?echo("checked"):echo(""))+" type=\"radio\">" + echo(types2.name) + "\r\n");
	}//end loop
	}
	...
	{
	loop__id++;
	ViewBuilder.Append("            <input id=\"typelist2\" name=\"typelist\" value=\"" + echo(types2.id) + "\" "+(FPArray.Contain(newsinfo.typelist,types2.id)?echo("checked"):echo(""))+" type=\"checkbox\">" + echo(types2.name) + "\r\n");
	}//end loop
	}
	else
	{
	...
	{
	loop__id++;
	ViewBuilder.Append("            <option value=\"" + echo(types2.id) + "\" is-checked=\"newsinfo.typelist#types2.id\">" + echo(types2.name) + "</option>\r\n");
	}//end loop
	...
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("          <td style=\"width:60px\">视频地址： </td>\r\n");
	ViewBuilder.Append("          <td>\r\n");
	ViewBuilder.Append("          <input style=\"width: 400px\" id=\"otherurl\" name=\"otherurl\" value=\"" + echo(newsinfo.otherurl) + "\">\r\n");
	ViewBuilder.Append("          </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("          <td style=\"width:60px\">视频作者： </td>\r\n");
	ViewBuilder.Append("          <td>\r\n");
	ViewBuilder.Append("          <input style=\"width: 400px\" id=\"author\" name=\"author\" value=\"" + echo(newsinfo.author) + "\">\r\n");
	ViewBuilder.Append("          </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        </table>\r\n");
	ViewBuilder.Append("        <table style=\"width:100%;\" class=\"border\">\r\n");
	...
	ViewBuilder.Append("        <table style=\"width:100%;\" class=\"border\">\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("          <td class=\"td_class\" style=\"width:60px\">视频图片： </td>\r\n");
	ViewBuilder.Append("          <td>\r\n");
	...
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("          <td class=\"td_class\" style=\"width:60px\">视频附件： </td>\r\n");
	ViewBuilder.Append("          <td>\r\n");
	ViewBuilder.Append("              <input type=\"text\" id=\"file\" name=\"file\" value=\"" + echo(newsinfo.file) + "\" style=\"width: 400px\"><br>\r\n");
	...
	ViewBuilder.Append("          <td>\r\n");
	ViewBuilder.Append("              <label for=\"status0\"><input id=\"status0\" name=\"status\" value=\"0\" "+(newsinfo.status==0?echo("checked"):echo(""))+" type=\"radio\">未审核</label> \r\n");
	ViewBuilder.Append("              <label for=\"status1\"><input id=\"status1\" name=\"status\" value=\"1\" "+(newsinfo.status==1?echo("checked"):echo(""))+" type=\"radio\">已审核</label>\r\n");
	ViewBuilder.Append("          </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	}
	else
