...
{
	/*方配软件技术有限公司(WMS框架)，官方网站：http://www.fangpage.com，生成时间：2018-08-17 09:36:48*/
	...
	ViewBuilder.Append("script>\r\n");
	ViewBuilder.Append("<script type=\"text/javascript\" src=\"" + plupath.ToString() + "calendar/WdatePicker.js\"></");
	ViewBuilder.Append("script>\r\n");
	...
	ViewBuilder.Append("        PageNav(\"" + GetSortNav(sortinfo,m_link).ToString() + "|添加编辑图片," + rawurl.ToString() + "\");\r\n");
	...
	ViewBuilder.Append("            window.location.href = \"mediamanage.aspx?sortid=" + sortid.ToString() + "\";\r\n");
	ViewBuilder.Append("        })\r\n");
	ViewBuilder.Append("    });\r\n");
	ViewBuilder.Append("</");
	ViewBuilder.Append("script>\r\n");
	...
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("          <td class=\"td_class\" style=\"width:60px\">视频文件： </td>\r\n");
	ViewBuilder.Append("          <td>\r\n");
	ViewBuilder.Append("              <input type=\"text\" id=\"file\" name=\"file\" value=\"" + newsinfo.file.ToString().Trim() + "\" style=\"width: 400px\">\r\n");
	ViewBuilder.Append("          </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        </table>\r\n");
	ViewBuilder.Append("        <table style=\"width:100%;\" class=\"border\">\r\n");
	...
	ViewBuilder.Append("          <td>\r\n");
	ViewBuilder.Append("             <input style=\"width: 400px\" id=\"postdatetime\" name=\"postdatetime\" value='" + FangPage.MVC.FPUtils.GetDate(newsinfo.postdatetime,"yyyy-MM-dd HH:mm:ss") + "' onfocus=\"WdatePicker({el:'postdatetime',dateFmt:'yyyy-MM-dd HH:mm:ss'})\" readonly=\"readonly\">\r\n");
	ViewBuilder.Append("          </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        </table>\r\n");
	ViewBuilder.Append("        <table style=\"width:100%;\" class=\"border\">\r\n");
