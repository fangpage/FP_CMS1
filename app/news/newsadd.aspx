...
protected override void View()
{
	...
	ViewBuilder.Append("        PageNav(\"" + echo(GetSortNav(sortinfo,m_link)) + "|添加编辑文章," + echo(rawurl) + "\");\r\n");
	...
	ViewBuilder.Append("            });\r\n");
	ViewBuilder.Append("        });\r\n");
	ViewBuilder.Append("        $(\"#btncancle\").click(function () {z\r\n");
	...
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("          <td style=\"width:60px;text-align:right;\">副标题： </td>\r\n");
	ViewBuilder.Append("          <td>\r\n");
	ViewBuilder.Append("          <input style=\"width: 400px\" id=\"subtitle\" name=\"subtitle\" value=\"" + echo(newsinfo.subtitle) + "\">\r\n");
	ViewBuilder.Append("          </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
