...
protected override void View()
{
	...
	ViewBuilder.Append("            window.location.href = \"downloadmanage.aspx?sortid=" + echo(sortid) + "\";\r\n");
	ViewBuilder.Append("        })\r\n");
	ViewBuilder.Append("        PageNav(\"" + echo(GetSortNav(sortinfo,pagename)) + "|添加编辑下载," + echo(rawurl) + "\");\r\n");
	ViewBuilder.Append("    });\r\n");
	ViewBuilder.Append("</");
	ViewBuilder.Append("script>\r\n");
	ViewBuilder.Append("</head>\r\n");
	...
	{
	ViewBuilder.Append("              <img id=\"titleimg\" src=\"" + echo(adminpath) + "statics/images/default.gif\" width=\"160\" height=\"160\">\r\n");
	}//end if
