<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_News.Controller.newslist" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("            <div class=\"right_top\"> <a target=\"_blank\" href=\"index.aspx\">首页</a>&nbsp;>&nbsp;<a href=\"newslist.aspx?sortid=" + echo(sortid) + "\">" + echo(sortinfo.name) + "</a> > 列表</div>\r\n");
	...
	loop__id=0;
	foreach(NewsInfo item in _newslist)
	{
	loop__id++;
	ViewBuilder.Append("                <li><a target=\"_blank\" href=\"newsinfo.aspx?id=" + echo(item.id) + "\" title=\"" + echo(item.title) + "\">" + echo(item.title) + "</a><span style=\"float:right;color:#ccc;font-size:12px;\">" + echo(item.postdatetime,"yyyy-MM-dd") + "</span></li>\r\n");
	}//end loop
	ViewBuilder.Append("              </ul>\r\n");
	ViewBuilder.Append("            </div>\r\n");
	ViewBuilder.Append("            <div class=\"clear\"></div>\r\n");
	ViewBuilder.Append("            <div class=\"pages\">\r\n");
	ViewBuilder.Append("              <div class=\"pagelist\"> <a class=\"a1\">共有" + echo(pager.total) + "条</a> <a href=\"?sortid=" + echo(sortid) + "&pageindex=" + echo(pager.prepage) + "\" class=\"a1\">上一页</a> <a href=\"?sortid=" + echo(sortid) + "&pageindex=" + echo(pager.nextpage) + "\" class=\"a1\">下一页</a>\r\n");
	...
	ViewBuilder.Append("    {\r\n");
	ViewBuilder.Append("      var url = \"newslist.aspx?sortid=\"+catid+\"&pageindex=\"+document.getElementById(\"page\").value;\r\n");
