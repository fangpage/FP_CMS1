          ...
          <div class="rightbox">
            ...
            <div class="nr1">
              <div class="nr1_bt" style="text-align:center;width:720px;float:left;margin-top:30px;">
                <h2 style="font-size: 20px; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 60px; width:600px;">${newsinfo.title}</h2>
              </div>
              <div class="rq"><span>来源：${newsinfo.source}</span><span style="margin-left:20px;">发布时间：${fmdate(_newsinfo.postdatetime,"yyyy-MM-dd")}</span><span style="margin-left:20px;">点击量：<span id="hits">${newsinfo.views}</span></span></div>
              <!--列表标题-->
