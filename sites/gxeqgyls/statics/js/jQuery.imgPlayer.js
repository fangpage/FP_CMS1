;(function($) {
	...
	settings = jQuery.extend(this,{
		...
		tBackgroundColor: 	  '#444444',		//标题背景颜色
		...
		iconColor:   		  '#ffffff',		//图标显示的颜色
		iconFontSize:   	  12,				//图标文字的大小(px)
		iconFontColor:   	  '#ffffff',		//图标的文字颜色
		iconBgUrl:   		  'none',			//图标显示的自定义图标(图片url)
		iconOpacity:   	      '0.6',			//图标显示的透明度
		activeIconSize:   	  20,				//激活时图标显示的大小(px)
		activeIconBorder:     '1px solid #7c7c7c',//激活时图标显示的边框
		activeIconColor:   	  '#3370c0',		//激活时图标显示的颜色
	...
	var $content = settings.children(".jquery-imagePlayer-title").children("div");//原本为div
