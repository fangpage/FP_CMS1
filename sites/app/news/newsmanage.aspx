      ...
      <div class="newslist">
          <div class="newsicon">
            <ul>
              ...
              <li style="background: url(${adminpath}images/add.gif) 2px 6px no-repeat"><a href="newsadd.aspx?sortid=${sortid}&typeid=${typeid}">添加</a></li>
              <li style="background: url(${adminpath}images/refresh.gif) 2px 6px no-repeat"><a href="newsmanage.aspx?sortid=${sortid}&typeid=${typeid}">刷新</a> </li>
      ...
      <table class="datalist" border="1" rules="all" cellspacing="0">
          <tbody>
            ...
            <tr class="tlist" onmouseover="curcolor=this.style.backgroundColor;this.style.backgroundColor='#cbe3f4'" onmouseout="this.style.backgroundColor=curcolor">
              ...
              <td><a style="color: #1317fc" href="newsadd.aspx?id=${news.id}">编辑</a></td>
            </tr>
            <%/loop %>
          </tbody>
        </table>
