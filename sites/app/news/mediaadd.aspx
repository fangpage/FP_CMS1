...
<script type="text/javascript">
    $(function () {
        ...
        $("#btncancle").click(function () {
            window.location.href = "mediamanage.aspx?sortid=${sortid}";
        })
    });
</script>
</head>
  ...
  <div class="newslistabout">
    <table class="borderkuang" border="0" cellspacing="0" cellpadding="0" width="100%">
     ...
     <table style="width:100%;" class="border">
        ...
        <%/if %>
        <tr>
          <td class="td_class" style="width:60px">视频文件： </td>
          <td>
              <input type="text" id="file" name="file" value="${newsinfo.file}" style="width: 400px"/>
          </td>
        </tr>
        </table>
        <table style="width:100%;" class="border">
        ...
        <table style="width:100%;" class="border">
        <tr>
          <td class="td_class" style="width:60px">视频图片： </td>
          <td>
              <%if {newsinfo.img}!="" %>
