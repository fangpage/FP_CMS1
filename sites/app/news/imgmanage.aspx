...
<body>
  ...
  <table class="ntcplist">
      ...
      <div class="newslist">
          <div class="newsicon">
            <ul>
              ...
              <li style="background: url(${adminpath}images/add.gif) 2px 6px no-repeat"><a href="imgadd.aspx?sortid=${sortid}&typeid=${typeid}">添加</a></li>
              <li style="background: url(${adminpath}images/refresh.gif) 2px 6px no-repeat"><a href="imgmanage.aspx?sortid=${sortid}&typeid=${typeid}">刷新</a> </li>
      ...
      <table class="datalist" border="1" rules="all" cellspacing="0">
          <tbody>
            ...
            <tr class="tlist" onmouseover="curcolor=this.style.backgroundColor;this.style.backgroundColor='#cbe3f4'" onmouseout="this.style.backgroundColor=curcolor">
              ...
              <td>
                  <a style="color: #1317fc" href="imgadd.aspx?id=${news.id}">编辑</a>
              </td>
            </tr>
            <%/loop %>
          </tbody>
    ...
    <tr>
       <td align="left">共有${pager.total}个图片，页次：${pager.pageindex}/${pager.pagecount}，${pager.pagesize}篇每页</td>
