...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("<title>栏目分类管理</title>\r\n");
	...
	ViewBuilder.Append("        })\r\n");
	ViewBuilder.Append("        PageNav(\"栏目分类管理," + rawpath.ToString() + "typemanage.aspx\");\r\n");
	ViewBuilder.Append("    })\r\n");
	...
	ViewBuilder.Append("            <li style=\"float:right; width:auto\"><strong>栏目分类管理</strong></li>\r\n");
	ViewBuilder.Append("        </ul>\r\n");
	...
	ViewBuilder.Append("            <td>" + types.id.ToString().Trim() + "</td>\r\n");
	...
	ViewBuilder.Append("            </td>\r\n");
	ViewBuilder.Append("            <td>" + types.markup.ToString().Trim() + "</td>\r\n");
	ViewBuilder.Append("            <td>\r\n");
	...
	ViewBuilder.Append("            </td>\r\n");
	ViewBuilder.Append("            <td>" + types.description.ToString().Trim() + "</td>\r\n");
	ViewBuilder.Append("            <td>\r\n");
