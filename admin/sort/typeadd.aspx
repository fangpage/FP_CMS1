...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("<title>添加编辑栏目分类</title>\r\n");
	...
	ViewBuilder.Append("        })\r\n");
	ViewBuilder.Append("        PageNav(\"栏目分类管理," + rawpath.ToString() + "typemanage.aspx|添加编辑分类," + rawurl.ToString() + "\");\r\n");
	...
	ViewBuilder.Append("          <td class=\"newstitle\" bgcolor=\"#ffffff\">添加编辑栏目分类</td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("      </tbody>\r\n");
	...
	ViewBuilder.Append("                  <option value=\"0\">分类根目录</option>\r\n");
