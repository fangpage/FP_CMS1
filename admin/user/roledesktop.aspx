...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("                                <td><input id=\"desktop\" name=\"desktop\" value=\"" + item.id.ToString().Trim() + "\" type=\"checkbox\" checked=\"checked\">\r\n");

	if (item.icon!="")
	{

	ViewBuilder.Append("                                      <img src=\"" + item.icon.ToString().Trim() + "\" width=\"32\" height=\"32\" style=\"vertical-align:middle\">\r\n");

	}
	else
	{

	ViewBuilder.Append("                                      <img src=\"../images/desktop.gif\" width=\"32\" height=\"32\">\r\n");
	...
	ViewBuilder.Append("                                <td><input id=\"desktop\" name=\"desktop\" value=\"" + item.id.ToString().Trim() + "\" type=\"checkbox\">\r\n");
	...
	ViewBuilder.Append("                                    " + item.name.ToString().Trim() + "</td>\r\n");
