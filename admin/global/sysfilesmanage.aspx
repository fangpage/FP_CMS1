...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("                          <li style=\"background: url(../images/back.png) 2px 6px  no-repeat\"><a href=\"" + reurl.ToString() + "\">返回上一级</a></li>\r\n");

	if (m_path=="/")
	{

	ViewBuilder.Append("                          <li style=\"float:right; width:auto\"><strong>系统文件管理(" + m_path.ToString() + ")</strong></li>\r\n");
	...
	ViewBuilder.Append("                    <input id=\"filepath" + files["id"].ToString().Trim() + "\" name=\"filepath" + files["id"].ToString().Trim() + "\" value=\"" + webpath.ToString() + "" + m_path.ToString() + "" + files["name"].ToString().Trim() + "\" type=\"hidden\">\r\n");
	...
	ViewBuilder.Append("                  <a href=\"" + webpath.ToString() + "" + m_path.ToString() + "" + files["name"].ToString().Trim() + "\" target=\"_blank\">浏览</a>\r\n");
