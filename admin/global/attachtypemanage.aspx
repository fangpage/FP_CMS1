...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("                </td>\r\n");
	ViewBuilder.Append("                <td>\r\n");
	ViewBuilder.Append("                    <input type=\"text\" style=\"width:100px\" name=\"edit_maxsize\" id=\"edit_maxsize\" value=\"" + item.maxsize.ToString().Trim() + "\">KB\r\n");
	...
	ViewBuilder.Append("                </td>\r\n");
	ViewBuilder.Append("                <td>\r\n");
	ViewBuilder.Append("                    <input type=\"text\" style=\"width:130px\" name=\"edit_type\" id=\"edit_type\" value=\"" + item.type.ToString().Trim() + "\">\r\n");
	ViewBuilder.Append("                </td>\r\n");
	ViewBuilder.Append("                <td>\r\n");
	...
	ViewBuilder.Append("              <td align=\"center\">" + FPUtils.FormatBytesStr(item.maxsize*1024).ToString().Trim() + "</td>\r\n");
	ViewBuilder.Append("              <td align=\"center\">" + item.type.ToString().Trim() + "</td>\r\n");
	ViewBuilder.Append("              <td>\r\n");
