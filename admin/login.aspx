...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("" + siteconfig.sitetitle.ToString().Trim() + "\r\n");
	...
	ViewBuilder.Append("              &nbsp;&nbsp;Copyright © 2013-" + verdate.ToString() + " <a href=\"http://www.fangpage.com\" target=\"_blank\">方配软件(FangPage.Com)</a>&nbsp;版权所有，版本：V" + siteconfig.version.ToString().Trim() + "\r\n");
