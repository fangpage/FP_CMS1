...
override protected void OnInitComplete(EventArgs e)
{
	...
	ViewBuilder.Append("><a href=\"javascript:void();\" target=\"leftframe\" onclick=\"javascript:switchTab('TabPage1','Tab" + loop__id.ToString() + "','sysmenu.aspx?parentid=" + menu.id.ToString().Trim() + "&topmenuid=" + menu.id.ToString().Trim() + "','desktop.aspx');\">\r\n");
	...
	ViewBuilder.Append("    </");
	ViewBuilder.Append("script>" + user.realname.ToString().Trim() + " \r\n");
	...
	ViewBuilder.Append("        <em>|</em><img src=\"images/wepsite.png\" width=\"16\" height=\"16\" style=\"vertical-align:middle\"><a href=\"global/sitemanage.aspx\" target=\"mainframe\">站点管理</a>\r\n");

	}	//end if

	ViewBuilder.Append("        <em>|</em><img src=\"images/more.gif\" width=\"16\" height=\"16\" style=\"vertical-align:middle\"><a href=\"desktop.aspx\" target=\"mainframe\">后台桌面</a> \r\n");
	ViewBuilder.Append("        <em>|</em><img src=\"images/bdesk.gif\" width=\"16\" height=\"16\" style=\"vertical-align:middle\">&nbsp;<a href=\"" + webpath.ToString() + "index.aspx\" target=\"_blank\">网站首页</a>\r\n");
